...
/****************************************************************************/
/* name  : rat_st, short form for 'rational number larger than'             */
/* param : rational number a, rational number b                             */
...
/****************************************************************************/
/* name  : rattostring, short form for 'rational to string'                 */
/* param : string of a rational number s                                    */
/* return: rational as read from the string                                 */
/****************************************************************************/
rational rattostring(char s[]);
